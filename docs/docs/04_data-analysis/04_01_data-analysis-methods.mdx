...
![](../../static/img/context/analysis/overview-text-as-data.png){fig-alt="Visualisation of key steps in text-as-data approaches" width="1000"}
...
![](../../static/img/context/analysis/preprocessing.png){fig-alt="Visualisation of how a sentence is transformed through preprocessing" width="700"}
...
![](../../static/img/context/analysis/dfm.png){fig-alt="Visualisation of two sentences represented in a DFM" width="1500"}
...
+==================================+=============================================================================================+===========================================================================================================================================================================================================================+
| **Dictionary**                   | Lists of relevant features to identify things like sentiments                               | ![R](../../static/img/context/analysis/r.png){fig-alt="Sign for programming language R" width="20"} [Tutorial R](https://bookdown.org/valerie_hase/TextasData_HS2021/tutorial-12-rule-based-approaches-dictionaries.html) |
|                                  |                                                                                             |                                                                                                                                                                                                                           |
|                                  |                                                                                             | ![Python](../../static/img/context/analysis/python.png){fig-alt="Sign for programming language python" width="20"} [Tutorial Python](https://cssbook.net/content/chapter11.html#sec-dictionary)                           |
+----------------------------------+---------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Semantic Network Analysis**    | Network analysis to analyse and visualise the co-occurrence of features                     | ![R](../../static/img/context/analysis/r.png){fig-alt="Sign for programming language R" width="20"} [Tutorial R](https://ladal.edu.au/net.html)                                                                           |
|                                  |                                                                                             |                                                                                                                                                                                                                           |
|                                  |                                                                                             | ![Python](../../static/img/context/analysis/python.png){fig-alt="Sign for programming language python" width="20"} [Tutorial Python](https://cssbook.net/content/chapter13.html)                                          |
+----------------------------------+---------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Supervised Machine Learning**  | Training of algorithms on manually annotated texts to classify known variables in new texts | ![R](../../static/img/context/analysis/r.png){fig-alt="Sign for programming language R" width="20"} [Tutorial R](https://content-analysis-with-r.com/5-machine_learning.html)                                             |
|                                  |                                                                                             |                                                                                                                                                                                                                           |
|                                  |                                                                                             | ![Python](../../static/img/context/analysis/python.png){fig-alt="Sign for programming language python" width="20"} [Tutorial Python](https://cssbook.net/content/chapter11.html#sec-supervised)                           |
+----------------------------------+---------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Topic Modelling**              | Using feature co-occurrences to identify previously unknown topics in texts                 | ![R](../../static/img/context/analysis/r.png){fig-alt="Sign for programming language R" width="20"} [Tutorial R](https://tinyurl.com/56mt46rd)                                                                            |
|                                  |                                                                                             |                                                                                                                                                                                                                           |
|                                  |                                                                                             | ![Python](../../static/img/context/analysis/python.png){fig-alt="Sign for programming language python" width="20"} [Tutorial Python](https://tinyurl.com/8cnfk2m3)                                                        |
+----------------------------------+---------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Large Language Models (LLMs)** | Using prompts to identify known variables in new texts using little or no training data     | ![R](../../static/img/context/analysis/r.png){fig-alt="Sign for programming language R" width="20"} [Tutorial R](https://www.youtube.com/watch?v=N-k3RZqiSZY)                                                             |
|                                  |                                                                                             |                                                                                                                                                                                                                           |
|                                  |                                                                                             | ![Python](../../static/img/context/analysis/python.png){fig-alt="Sign for programming language python" width="20"} [Tutorial Python](https://github.com/mlabonne/llm-course)                                              |
+----------------------------------+---------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
![](../../static/img/context/analysis/semantic-network.png){fig-alt="Visualisation of a semantic network"}
