...
All contributors are listed [here](https://github.com/bertelsmannstift/data-knowledge-hub/blob/main/docs/docs/06_contribute/06_02_community.mdx) as well as named in their respective chapters.
...
- **[How to get started](https://github.com/bertelsmannstift/data-knowledge-hub/blob/main/docs/docs/01_get-started/01_01_intro-get-started.md)**: Overview of legal and ethical considerations as well as tools you may use during your project.
- **[How to access data on platforms](https://github.com/bertelsmannstift/data-knowledge-hub/blob/main/docs/docs/02_data-access/02_01_intro-access.md)**: Information on data access options available for each platform.
- **[How to collect data](https://github.com/bertelsmannstift/data-knowledge-hub/blob/main/docs/docs/03_data-collection/03_01_intro-collection.md)**: Summary of data collection methods and tools, along with challenges, limitations, and potential.
- **[How to analyse data](https://github.com/bertelsmannstift/data-knowledge-hub/blob/main/docs/docs/04_data-analysis/04_01_intro-analysis.md)**: Introduction to research designs and methods like natural language processing, network analysis, and machine learning.
- **[Literature and Illustrative Research](https://github.com/bertelsmannstift/data-knowledge-hub/blob/main/docs/docs/05_literature/05_01_intro-literature.md)**: Overview of literature and selected research and studies.
- **[Contribute](https://github.com/bertelsmannstift/data-knowledge-hub/blob/main/docs/docs/06_contribute/06_01_how-to-contribute.md)**: Now it's your turn. Information on how you can support us and make your research available to the data knowledge community.

### Questions and improvements

If you have any questions or ideas, please do not hesitate to contact us at **[upgrade.democracy@bertelsmann-stiftung.de](mailto:upgrade.democracy@bertelsmann-stiftung.de)**.
