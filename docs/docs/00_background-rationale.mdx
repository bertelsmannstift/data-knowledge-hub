...
- **[How to get started](get-started)**: Overview of legal and ethical considerations as well as tools you may use during your project.
- **[How to access data on platforms](data-access)**: Information on data access options available for each platform.
- **[How to collect data](data-collection)**: Summary of data collection methods and tools, along with challenges, limitations, and potential.
- **[How to analyse data](data-analysis)**: Introduction to research designs and methods like natural language processing, network analysis, and machine learning.
- **[Literature and Illustrative Research](literature)**: Overview of literature and selected research and studies.
- **[Contribute](contribute/06_01_how-to-contribute)**: Now it's your turn. Information on how you can support us and make your research available to the data knowledge community.
