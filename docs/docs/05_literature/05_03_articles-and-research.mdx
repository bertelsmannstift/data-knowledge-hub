...
Add the link to the publication together with a headline and a short teaser text (approx. 50 words) directly via a GitHub pull request. You can find a detailed description of how this works in our [‘How to contribute’](/docs/06_contribute/06_01_how-to-contribute) chapter. Alternatively, you can also send it to us by email at [upgrade.democracy@bertelsmann-stiftung.de](mailto:upgrade.democracy@bertelsmann-stiftung.de). 
