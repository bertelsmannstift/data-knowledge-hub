...
# Roadmap
<LastUpdatedByChip authorOriginal="Johannes Müller" createdOn="13.09.2024" authorLastUpdate="Johannes Müller" updatedOn="29.01.2025" />
...
- [X] Update overall design and user interface
- [X] Add more custom elements to the Data Knowledge Hub
- [X] Update structure of the Data Knowledge Hub to improve user experience

### Version 1.3 (Q4 2024) 

- [X] Add more ways to contribute to the Data Knowledge Hub
- [X] New feature for more dynamic contribution panels
- [X] Collect user feedback and update content library for a better user journey
