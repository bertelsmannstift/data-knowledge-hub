---
sidebar_position: 1
title: The Data Knowledge Hub for Researching Online Discourse
---
...
- **[Ethical, Social, and Legal Context](context/intro)**: Overview of key issues and challenges, including regulatory bases, privacy, bias, and transparency.
- **[Data Collection](data-collection/intro)**: Summary of data collection methods and tools, along with challenges, limitations, and potential.
- **[Methods and Analysis](methods/methods)**: Introduction to research designs and methods like natural language processing, network analysis, and machine learning.
