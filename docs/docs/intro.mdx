...
| ------------------------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ---- |
| `tiktok-scraping`         | Collect data on TikTok using puppeteer | <img src="https://upload.wikimedia.org/wikipedia/commons/6/6a/JavaScript-logo.png?20120221235433" width="20" height="20" /> JavaScript                  | TikTok      | Code |
| `tiktok-hashtag-analysis` | Analyse TikTok Hashtags                | <img src="https://s3.dualstack.us-east-2.amazonaws.com/pythondotorg-assets/media/community/logos/python-logo-only.png" width="20" height="20" /> Python | TikTok      | Code |
| `blog-webscraping`        | Webscraping using rvest and selenium   | <img src="https://www.r-project.org/logo/Rlogo.png" width="20" height="20" /> R                                                                         | Blogs       | Code |
...
| `twitter-social-network`  | Social Network Analysis with R         | <img src="https://www.r-project.org/logo/Rlogo.png" width="20" height="20" /> R                                                                         | Twitter / X | Code |
